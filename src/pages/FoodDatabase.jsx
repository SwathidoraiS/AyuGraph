...
const FoodGrid = () => {
  ...
  },
  {
    name: "Ghee",
    category: "Dairy",
    description: "Clarified butter, nourishing for Vata, improves digestion.",
    calories: "120 kcal",
    rasa: "Sweet",
    virya: "Heating",
    vipaka: "Sweet",
    doshaEffect: "Balances Vata, Increases Pitta",
    tags: ["Nourishing", "Digestive", "Lubricating"],
  },
  {
    name: "Turmeric",
    category: "Spices",
    description: "Anti-inflammatory spice that balances Kapha and Pitta.",
    calories: "29 kcal",
    rasa: "Bitter",
    virya: "Heating",
    vipaka: "Pungent",
    doshaEffect: "Balances Kapha and Pitta",
    tags: ["Anti-inflammatory", "Healing", "Spicy"],
  },
  {
    name: "Almonds",
    category: "Nuts",
    description: "Rich in healthy fats, supports Vata, nourishing for skin and brain.",
    calories: "160 kcal",
    rasa: "Sweet",
    virya: "Heating",
    vipaka: "Sweet",
    doshaEffect: "Balances Vata",
    tags: ["Nourishing", "Brain-boosting", "Skin-friendly"],
  },
  {
    name: "Coconut Water",
    category: "Beverages",
    description: "Cooling drink, balances Pitta, hydrates naturally.",
    calories: "19 kcal",
    rasa: "Sweet",
    virya: "Cooling",
    vipaka: "Sweet",
    doshaEffect: "Balances Pitta",
    tags: ["Hydrating", "Cooling", "Refreshing"],
  },
  ]);
  ...
  const handleAddOrEditFood = (e) => {
    e.preventDefault();
    const foodToSave = { ...newFood, tags: newFood.tags.split(",").map((t) => t.trim()) };

    if (editIndex !== null) {
      const updatedFoods = [...foods];
      updatedFoods[editIndex] = foodToSave;
  ...
  const handleEdit = (index) => {
    ...
    setNewFood({ ...food, tags: food.tags.join(", ") });
    setEditIndex(index);
    setShowForm(true);
  };
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-lg">
            <h2 className="text-xl font-semibold mb-4">{editIndex !== null ? "Edit Food" : "Add New Food"}</h2>
            <form onSubmit={handleAddOrEditFood} className="space-y-3">
              <input
                type="text"
                name="name"
              ...
              <div className="flex justify-end gap-3 mt-3">
                ...
                >
                  {editIndex !== null ? "Save Changes" : "Add Food"}
                </button>
              </div>
            </form>
          </div>
